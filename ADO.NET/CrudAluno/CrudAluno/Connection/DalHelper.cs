...
namespace CShp_ComboTextBox
{
    public class DalHelper : IDisposable
    {
        ...
        public static DataTable GetAlunos()
        {
            ...
            try
            {
                //using define que após o uso vai liberar os recurso e precisa herda IDisposable para poder usar
                //Precisa implementar o método dispose()
                using (var cmd = DbConnection().CreateCommand())
                {
                    cmd.CommandText = "SELECT  AlunoId,Nome,Endereco,Email,Telefone FROM Alunos";
        ...
        //        using (var cmd = DbConnection().CreateCommand())
        //        {
        //            cmd.CommandText = "SELECT  AlunoId,Nome,Endereco,Email,Telefone FROM Alunos Where AlunoId=" + id;
        //            da = new SqlDataAdapter(cmd.CommandText, DbConnection());
        //            da.Fill(dt);
        //            return dt;
        //        }
